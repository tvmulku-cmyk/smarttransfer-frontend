...
const RegisterDriverPage: React.FC = () => {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            ...
            const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/api/auth/register-driver`, values);
    ...
    const uploadProps = (field: string) => ({
        name: 'file',
        action: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/api/upload/driver-docs`,
        headers: {
