...
const SiteSettingsPage: React.FC = () => {
    ...
    const handleSaveGoogleMaps = async () => {
        try {
            const res = await axios.put(`${process.env.NEXT_PUBLIC_API_URL || 'https://smarttransfer-backend-production.up.railway.app'}/api/tenant/settings`, {
    ...
    const handleAddImage = async () => {
        ...
        try {
            ...
            const res = await axios.put(`${process.env.NEXT_PUBLIC_API_URL || 'https://smarttransfer-backend-production.up.railway.app'}/api/tenant/hero-images`, {
