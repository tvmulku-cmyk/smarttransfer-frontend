...
const SiteSettingsPage: React.FC = () => {
    ...
    const handleSaveGoogleMaps = async () => {
        try {
            const res = await axios.put(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/api/tenant/settings`, {
    ...
    const handleAddImage = async () => {
        ...
        try {
            ...
            const res = await axios.put(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/api/tenant/hero-images`, {
